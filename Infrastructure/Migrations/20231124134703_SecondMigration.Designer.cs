...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231124134703_SecondMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Concrete.Alliance_Country", b =>
                {
                    ...
                    b.Property<long?>("Alliance_CountryId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Concrete.Alliance", b =>
                {
                    b.HasOne("Domain.Concrete.Alliance", null)
                        .WithMany("Alliance_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.Alliance_Country", b =>
                {
                    ...
                    b.HasOne("Domain.Concrete.Alliance_Country", null)
                        .WithMany("Alliance_Country_Categories")
                        .HasForeignKey("Alliance_CountryId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Concrete.Battle", b =>
                {
                    b.HasOne("Domain.Concrete.Battle", null)
                        .WithMany("Battle_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.ByHour", b =>
                {
                    b.HasOne("Domain.Concrete.ByHour", null)
                        .WithMany("ByHour_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.Country", b =>
                {
                    b.HasOne("Domain.Concrete.Country", null)
                        .WithMany("Country_Categories")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Domain.Concrete.Faction", b =>
                {
                    b.HasOne("Domain.Concrete.Faction", null)
                        .WithMany("Faction_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.GlobalWar", b =>
                {
                    b.HasOne("Domain.Concrete.GlobalWar", null)
                        .WithMany("GlobalWar_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.Unit", b =>
                {
                    b.HasOne("Domain.Concrete.Unit", null)
                        .WithMany("Unit_Categories")
            ...
            modelBuilder.Entity("Domain.Concrete.Alliance", b =>
                {
                    b.Navigation("Alliance_Categories");
                });

            modelBuilder.Entity("Domain.Concrete.Alliance_Country", b =>
                {
                    b.Navigation("Alliance_Country_Categories");
                });

            modelBuilder.Entity("Domain.Concrete.Battle", b =>
                {
                    b.Navigation("Battle_Categories");
                });

            modelBuilder.Entity("Domain.Concrete.ByHour", b =>
                {
                    b.Navigation("ByHour_Categories");
                });
            ...
            modelBuilder.Entity("Domain.Concrete.Country", b =>
                {
                    b.Navigation("Country_Categories");
                });

            modelBuilder.Entity("Domain.Concrete.Faction", b =>
                {
                    b.Navigation("Faction_Categories");
                });

            modelBuilder.Entity("Domain.Concrete.GlobalWar", b =>
                {
                    b.Navigation("GlobalWar_Categories");
                });
